...
//                                let svm = KNN(comparison_factor_id: state.factor_ids[section], comparison_level_ids: selected_level_ids_in_section)
//                                let svm_validation_selection_state = KNNValidationSelectionState(knn: knn)
