...
class NameColorTableView: UIView, TiledScrollViewDelegate {
                ...
                for var x = 0; x < columnWidths.count; ++x {
                        ...
                        if originX + width > rect.minX {
                                ...
                                for var y = startY; y < endY; ++y {
                                        ...
                                        drawNameAndColorCircle(context: ctx, originX: originX, originY: originY, width: width, height: rowHeight, lineWidth: lineWidth, name: name, font: cellFont, circleColor: color, circleRadius: circleRadius, margin: margin, topLine: topLine, leftLine: leftLine)
                                }
                        }
                        originX += width
                }
        ...
        func drawNameAndColorCircle(context ctx: CGContext, originX: CGFloat, originY: CGFloat, width: CGFloat, height: CGFloat, lineWidth: CGFloat, name: String, font: UIFont, circleColor: UIColor?, circleRadius: CGFloat, margin: CGFloat, topLine: Bool, leftLine: Bool) {
                CGContextSaveGState(ctx)
